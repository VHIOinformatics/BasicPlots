...
#' @param method: linkage method to cluster samples. Values given by parameter method of hclust function
...
#' @param toPdf TRUE to create a .pdf file 
#' @param toPng TRUE to create a .png file 
...
oneCluster <-function(estimates = NULL, resultsDir = NULL, fileName = NULL, fmtPlot = "pdf", 
